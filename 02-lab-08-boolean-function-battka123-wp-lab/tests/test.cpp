...
TEST(BooleanFunction, Operators)
{
    ...
    std::vector<bool> vec_1 = {0, 0, 0, 0, 1, 1, 1, 1};
    std::vector<bool> vec_2 = {0, 0, 1, 1, 0, 0, 1, 1};
    std::vector<bool> vec_3 = {0, 1, 0, 1, 0, 1, 0, 1};
    vecOfBF.emplace_back(vec_1);
    vecOfBF.emplace_back(vec_2);
    vecOfBF.emplace_back(vec_3);
    vec1 = {1, 0, 1, 1, 0, 0, 1, 1};
    std::vector<bool> vec2 = {1, 0, 1, 1, 0, 0, 1, 1};
